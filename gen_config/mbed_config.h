...
#define MBED_CONF_APP_LORA_ANT_SWITCH                                         A4                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_CS                                                 D10                                                                                                // set by application[K64F]
#define MBED_CONF_APP_LORA_DIO0                                               D2                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_DIO1                                               D3                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_DIO2                                               D4                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_DIO3                                               D5                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_DIO4                                               D8                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_DIO5                                               D9                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_PWR_AMP_CTL                                        NC                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_RADIO                                              SX1276                                                                                             // set by application
#define MBED_CONF_APP_LORA_RESET                                              A0                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_RF_SWITCH_CTL1                                     NC                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_RF_SWITCH_CTL2                                     NC                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_RXCTL                                              NC                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_SPI_MISO                                           D12                                                                                                // set by application[K64F]
#define MBED_CONF_APP_LORA_SPI_MOSI                                           D11                                                                                                // set by application[K64F]
#define MBED_CONF_APP_LORA_SPI_SCLK                                           D13                                                                                                // set by application[K64F]
#define MBED_CONF_APP_LORA_TCXO                                               NC                                                                                                 // set by application[K64F]
#define MBED_CONF_APP_LORA_TXCTL                                              NC                                                                                                 // set by application[K64F]
