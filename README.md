...
Please select your radio type by modifying the `lora-radio` field in the `mbed_app.json` and providing a pin set if it is different from the default. For example:
